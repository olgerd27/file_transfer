...
//    filename_src = "../test/test_trans_files/file_orig.txt";
    if (!get_filename_inter(".", filename_src)) return;
  ...
  // TODO: maybe add here the confirmation dialog like:
  //  Upload/Download hostname:filename_src to hostname:filename_trg? (y/n):
